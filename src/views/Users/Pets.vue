  ...
  <div >
    <div>
      ...
      <!-- <div @click="imageClick"> -->
        ...
        <div align="center">
          <b-dropdown offset="0" text="Type" class="m-5" >
        ...
        <div align="center" v-if="petTypeSelected ==='Dogs'">
          ...
          <div align="center" v-if="petAgeSelected ==='Puppies/Kittens'">
            <b-carousel
              ...
              >
                <b-carousel-slide caption="Puppies" img-blank img-alt="Blank image">
          ...
          <div v-else-if="petAgeSelected === 'Adults'">
             <b-carousel
              ...
              @sliding-end="onSlideEnd"
            >
              <b-carousel-slide caption="Adults" img-blank img-alt="Blank image">
                <p>
          ...
          <div v-else>
            <b-carousel
              ...
              @sliding-end="onSlideEnd"
            >
              <b-carousel-slide caption="Seniors" img-blank img-alt="Blank image">
                <p>
        ...
        <div align="center" v-else>
          ...
          <div v-if="petAgeSelected ==='Puppies/Kittens'">
             <b-carousel
              ...
              @sliding-end="onSlideEnd"
            >
              <b-carousel-slide caption="Kittens" img-blank img-alt="Blank image">
                <p>
