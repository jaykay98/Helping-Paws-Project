  ...
  <b-container>
    <b-row>
      <b-col>
        ...
        <p
          class="text-justify"
        >Behavioural problems can be due to behavioural causes, medical causes, or both. Our veterinarians will investigate behavioural problems by obtaining a full history and conducting a full examination (sometimes your pet may require blood or urine tests to rule out underlying medical conditions) to accurately diagnose a problem. Behavioural problems are often the combined effect of many factors, including your pet’s environment and learning.</p>
        <p
          class="text-justify"
        >Genetics can also predispose your pet to some behaviours, however the expression of those behaviours will depend on your pet’s early socialisation and training.</p>
        <p
          class="text-justify"
